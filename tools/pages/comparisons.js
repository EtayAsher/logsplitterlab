...
module.exports = function comparisonsIndex(ctx) {
  ...
  const ARTICLES = [
    ...
    },
    {
      ...
      summary: 'Compares the WEN 56208 and BILT HARD 6.5-Ton by cycle time, warranty, and electrical requirements.',
      updated: '2026-07-26',
    ...
    },
    {
      ...
      summary: 'Compares the Landworks GUO079 and Champion 100250 by engine, cycle time, log length, and towing.',
      updated: '2026-07-26',
