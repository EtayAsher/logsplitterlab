...
module.exports = function comparisonsIndex(ctx) {
  ...
  const ARTICLES = [
    ...
    },
    {
      ...
      summary: 'Compares the WEN 56208 and SuperHandy GUO084 by tonnage, cycle time, and electrical requirements.',
      updated: '2026-07-27',
    ...
    },
    {
      ...
      summary: 'Compares the Landworks GUO079 and SuperHandy GUO096 by engine, cycle time, log capacity, and horizontal/vertical operation.',
      updated: '2026-07-27',
