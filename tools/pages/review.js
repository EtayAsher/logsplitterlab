...
const ANALYSIS = {
  ...
  'superhandy-20-ton': {
    ...
    whoShouldChooseOther: 'If you want more tonnage or vertical operation for large rounds, the BILT HARD TLA-0131 (27 tons, horizontal/vertical, towable) is a closer next step up than jumping straight to our largest model, or the YARDMAX YU3266 (32 tons) if you want the most capacity in our catalog — both are genuinely different machines, not just a different brand at the same spec.',
    faq: [
    ...
    alternativeId: 'bilthard-tla-0131',
    alternativeNote: 'The BILT HARD TLA-0131 offers more tonnage (27T vs. 20T) and horizontal/vertical operation this model doesn\'t have, with towing hardware this model lacks a confirmed rating for — a meaningful step up without going all the way to our largest, 32-ton model. Note BILT HARD\'s manufacturer warranty does not cover Amazon purchases, unlike this model.',
    publishedDate: '2026-07-26',
  ...
  'landworks-guo079': {
    ...
    whoShouldChooseOther: 'If you need to split large rounds vertically without lifting them onto a beam, want more tonnage headroom, or want towing hardware, the BILT HARD TLA-0131 (27 tons, horizontal/vertical, towable) is a closer next step up, or the YARDMAX YU3266 (32 tons) for the most capacity in our catalog — both are genuinely different machines, worth comparing before the SuperHandy GUO077, which is nearly identical to this product on paper.',
    faq: [
      { q: 'Can the Landworks GUO079 be towed behind a vehicle on the road?', a: 'No confirmed road-tow hitch rating was found in our sourcing. It moves via its own transport wheels — treat it as property-portable rather than road-towable. The BILT HARD TLA-0131 and YARDMAX YU3266 elsewhere in our catalog both ship with towing hardware, if that matters to you.' },
      ...
      { q: 'How is this different from the SuperHandy GUO077 in your catalog?', a: 'In every specification we could verify, it isn\'t meaningfully different — both are 20-ton machines from the same manufacturer (GCM) with matching weight, cycle time, and log capacity. We disclose this directly rather than presenting them as a meaningful choice; if you want a genuinely different machine, compare the BILT HARD TLA-0131 or YARDMAX YU3266 instead.' },
    ],
    alternativeId: 'bilthard-tla-0131',
    alternativeNote: 'The BILT HARD TLA-0131 offers more tonnage (27T vs. 20T) and horizontal/vertical operation this model doesn\'t have, with towing hardware this model lacks a confirmed rating for — a meaningful step up without going all the way to our largest, 32-ton model, and a more meaningful comparison than the SuperHandy GUO077, which shares nearly identical specs with this product. Note BILT HARD\'s manufacturer warranty does not cover Amazon purchases, unlike this model.',
    publishedDate: '2026-07-26',
    updatedDate: '2026-09-09',
  },
  'yardmax-32-ton-cr950': {
    ...
    whoShouldChooseOther: 'If cycle time or a lighter, more portable unit matters more than maximum tonnage, the Landworks GUO079 (or the nearly-identical SuperHandy GUO077) are real alternatives at a lower, 20-ton tonnage. If you want horizontal/vertical operation and towing hardware but not quite this much machine, the BILT HARD TLA-0131 (27 tons) is a smaller step down — though note its manufacturer warranty does not cover Amazon purchases, unlike this model.',
    faq: [
    ...
    alternativeId: 'bilthard-tla-0131',
    alternativeNote: 'Compared to the BILT HARD TLA-0131, this YARDMAX model offers more tonnage (32T vs. 27T), a longer max log length, and a manufacturer-confirmed 45 mph tow rating the TLA-0131 doesn\'t publish — at a slower cycle time (15.3s vs. 13s) and a much heavier unit. The TLA-0131 is meaningfully cheaper to own in warranty terms only if bought directly from BILT HARD rather than Amazon.',
    publishedDate: '2026-07-26',
    updatedDate: '2026-09-09',
  },
  'bilthard-tla-0101': {
  ...
  'bilthard-tla-0131': {
    verdict: 'A 27-ton gas splitter with horizontal/vertical operation and towing hardware, sitting between the two 20-ton portable models and the 32-ton YARDMAX in our catalog — a real midrange step up in force and capability, bought with an important caveat: BILT HARD\'s own warranty does not cover Amazon purchases.',
    bestFor: 'Homeowners or rural property owners who\'ve outgrown a 20-ton portable splitter but don\'t need the YARDMAX YU3266\'s full 32-ton, full-beam scale, and who want horizontal/vertical operation and towing hardware in between.',
    notIdealFor: 'Anyone who wants manufacturer warranty coverage on their purchase (not available through Amazon for this product), or who needs a confirmed unit weight, dimensions, or road-tow speed rating before buying — none of those are published by the manufacturer for this model.',
    strengths: [
      '27 tons of force, horizontal/vertical operation, per the manufacturer — meaningfully more capable than the horizontal-only 20-ton pair in our catalog',
      'Towing hardware (2-inch ball coupler, 16-inch DOT tires) confirmed by both the manufacturer and the Amazon listing\'s own title, which explicitly describes it as "Towable"',
      '13-second cycle time, per the manufacturer — faster than the YARDMAX YU3266\'s 15.3 seconds, though slower than the 20-ton pair\'s 7.5 seconds',
    ],
    limitations: [
      'BILT HARD\'s own warranty policy explicitly excludes purchases made through Amazon or any other third-party marketplace — see the warranty note below before assuming any coverage',
      'Unit weight, product dimensions, hydraulic fluid type/capacity, and a confirmed road-tow speed rating are not published by the manufacturer for this model and are not shown here — we found unattributable figures for some of these on secondary sources but could not confirm them on the manufacturer\'s own page, so we left them out rather than publish an unverified number',
      'Slower cycle time than either 20-ton model in our catalog (13s vs. 7.5s), the tradeoff for the extra tonnage and horizontal/vertical capability',
    ],
    workload: 'Fits a homeowner or rural property owner processing more wood, or larger/tougher rounds, than a 20-ton portable comfortably handles — without needing the YARDMAX YU3266\'s largest-in-catalog 32-ton scale.',
    cycleTimeNote: 'A 13-second cycle time, per the manufacturer, lands between the two 20-ton models in our catalog (7.5 seconds each) and the YARDMAX YU3266 (15.3 seconds) — a real middle point, not just a middle tonnage.',
    logSizeNote: 'Rated for logs up to 24 in. long, per the manufacturer — longer than either 20-ton model\'s 20 in. rating, though shorter than the YARDMAX YU3266\'s 26 in. A maximum log diameter is not published by the manufacturer for this model, so we\'re not stating one.',
    portabilityNote: 'Ships with a 2-inch ball coupler and 16-inch DOT-rated tires, per the manufacturer, and the Amazon listing\'s own title describes it as towable — real, confirmed towing hardware. Unlike the YARDMAX YU3266 in our catalog, whose manufacturer publishes a specific 45 mph tow rating, we found no manufacturer-published road-speed rating for this model; confirm towing limits with the manufacturer or a licensed transport professional before towing on public roads.',
    setupStorageNote: 'Assembly requirements are not detailed on the manufacturer\'s product page. Store indoors or under cover; stabilize or drain fuel per standard small-engine practice if storing over winter, and retract the ram fully.',
    noiseElectricalNote: 'Gas-powered, so expect engine noise and exhaust; no electrical hookup required.',
    usability: 'A 2-stage gear pump and a 23-inch cylinder stroke drive the 27-ton rating through horizontal or vertical operation, per the manufacturer. Specific pump GPM and hydraulic fluid capacity are not published for this model.',
    maintenance: 'Follow the 209cc OHV engine\'s oil and service schedule and check hydraulic fluid periodically — specific fluid type and capacity are not published by the manufacturer for this model, so check the included manual rather than assume a figure from another product in our catalog.',
    whoShouldBuy: 'Choose this if you need more force and horizontal/vertical operation than a 20-ton portable machine offers, want towing hardware without the YARDMAX YU3266\'s largest-in-catalog scale, and are comfortable buying through Amazon knowing that forfeits BILT HARD\'s manufacturer warranty.',
    whoShouldChooseOther: 'If warranty coverage matters more than the convenience of buying through Amazon, BILT HARD\'s own warranty is only honored on purchases made directly through bilthardusa.com — worth weighing before buying this listing. If 20 tons is genuinely enough for your wood and a faster 7.5-second cycle time matters more than the extra force, the SuperHandy GUO077 or Landworks GUO079 in our catalog cost less machine to own. If you need the most tonnage, log length, and a manufacturer-confirmed road-tow speed rating in our catalog, the YARDMAX YU3266 (32 tons) is the larger step up. See our Best Gas Log Splitters roundup for the full comparison.',
    faq: [
      { q: 'Is the BILT HARD TLA-0131 covered by a warranty if I buy it on Amazon?', a: 'No — per BILT HARD\'s own warranty policy, coverage "applies only to products purchased directly from the official Bilt Hard website," and explicitly states that "purchases from third-party platforms such as Amazon, Walmart, or eBay are not covered." Buying this listing through Amazon means buying without BILT HARD\'s manufacturer warranty.' },
      { q: 'How does the TLA-0131 compare to your 20-ton gas models?', a: 'It offers more force (27 vs. 20 tons), horizontal/vertical operation (the 20-ton pair is horizontal-only), and confirmed towing hardware — at a slower cycle time (13s vs. 7.5s) and, per BILT HARD\'s warranty policy, no manufacturer warranty when bought via Amazon, unlike the more standard coverage on our other gas models.' },
      { q: 'What is the maximum log diameter for the TLA-0131?', a: 'Not published by the manufacturer for this model. We confirmed a 24 in. maximum log length directly from the manufacturer\'s product page, but no diameter figure — rather than estimate one, we\'ve left it unset.' },
    ],
    alternativeId: 'landworks-guo079',
    alternativeNote: 'If 27 tons and horizontal/vertical operation are more than you need, the Landworks GUO079 (20 tons, gas, horizontal-only) is a lighter, faster-cycling machine in our catalog at a lower tonnage — worth comparing before paying for capability you may not use.',
